...
public class GridPasswordView extends LinearLayout implements PasswordView {
    ...
    private void inflaterViews(Context context) {
        ...
        inflater.inflate(R.layout.pay_gridpasswordview, this);
        ...
        while (index < mPasswordLength) {
            View dividerView = inflater.inflate(R.layout.pay_divider, null);
            ...
            TextView textView = (TextView) inflater.inflate(R.layout.pay_textview, null);
            ...
            if (TextUtils.isEmpty(getPassWord())) {
                ...
                if (newStr.length() == 1) {
                    ...
                    for (int i = 0; i < newStr.length(); i++) {
                        ...
                        for (int j = 0; j < mPasswordArr.length; j++) {
                            if (mPasswordArr[j] == null) {
                                mPasswordArr[j] = newNum;
                                mViewArr[j].setText(newNum);
                                notifyTextChanged();
                                break;
                            }
                        }
