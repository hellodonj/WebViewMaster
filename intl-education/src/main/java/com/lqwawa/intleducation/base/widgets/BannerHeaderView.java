 ...
 * android banner图
 */
public class BannerHeaderView extends FrameLayout implements OnPageChangeListener {
    ...
    public BannerHeaderView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void setImgUrlData(List<String> urlList) {
        ...
        if (mUrlList != null && !mUrlList.isEmpty()) {
            ...
            for (int i = 0; i < mUrlList.size(); i++) {
                ...
                //设置点的间距
                params.setMargins(0, 0, DisplayUtil.dip2px(mContext, 8), 0);
