...
public class NumberTool {
    ...
    public static String numberToChinese(String numString) {//转化一个阿拉伯数字为中文字符串
        if (StringUtils.isIntString(numString)){
            if (!StringUtils.languageIsEnglish()) {
                return numberToChinese(Integer.parseInt(numString));
            }else{
                return numString;
            }
        }else{
