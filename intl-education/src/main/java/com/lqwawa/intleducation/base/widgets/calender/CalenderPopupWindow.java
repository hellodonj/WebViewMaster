package com.lqwawa.intleducation.base.widgets.calender;
...
public class CalenderPopupWindow extends PopupWindow implements View.OnClickListener, OnCalendarClickListener {
    ...
    public CalenderPopupWindow(Date date, final Activity context, OnDatePickListener datePickListener ) {
        mContext = context;
    ...
    private void setProperty() {
        ...
        int w = DisplayUtil.getMobileWidth(mContext);
        mWidth = w;
    ...
    public void onClick(View v) {
        int viewId = v.getId();
        if(viewId == R.id.back_to_today){
            backToToday();
        }else if(viewId == R.id.pre_month){
            switchToPreMonth();
