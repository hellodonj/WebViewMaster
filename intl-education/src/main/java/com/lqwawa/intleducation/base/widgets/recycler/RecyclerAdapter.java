package com.lqwawa.intleducation.base.widgets.recycler;
...
public abstract class RecyclerAdapter<Data>
    ...
    public void onClick(View v) {
        ...
        if (this.mListener != null) {
            ...
            int realPos = pos - getHeaderCount();
            // 回掉方法
            this.mListener.onItemClick(viewHolder, mDataList.get(realPos));
        }
    ...
    public boolean onLongClick(View v) {
        ...
        if (this.mListener != null) {
            ...
            int realPos = pos - getHeaderCount();
            // 回掉方法
            this.mListener.onItemLongClick(viewHolder, mDataList.get(realPos));
            return true;
        }
        return false;
    }
    ...
    /**
     * 获取头部布局的个数,HFRecyclerAdapter需要重写此方法
     * @return int
     */
    ...
    /**
     * 获取尾部布局的个数,HFRecyclerAdapter需要重写此方法
     * @return int
     */
