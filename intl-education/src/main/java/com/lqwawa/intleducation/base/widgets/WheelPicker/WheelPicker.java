package com.lqwawa.intleducation.base.widgets.WheelPicker;
...
public class WheelPicker extends View implements IWheelPicker, Runnable {
    ...
    public WheelPicker(Context context, AttributeSet attrs) {
        ...
        mItemTextSize = a.getDimensionPixelSize(R.styleable.WheelPicker_wheel_item_text_size,
                getResources().getDimensionPixelSize(R.dimen.com_font_size_7));
        ...
        mItemSpace = a.getDimensionPixelSize(R.styleable.WheelPicker_wheel_item_space,
                getResources().getDimensionPixelSize(R.dimen.com_font_size_3));
        ...
        mIndicatorSize = a.getDimensionPixelSize(R.styleable.WheelPicker_wheel_indicator_size,
                getResources().getDimensionPixelSize(R.dimen.com_item_space_xxs));
    ...
    private void computeIndicatorRect() {
        ...
        int indicatorHeadCenterY = mWheelCenterY + mHalfItemHeight * 4 / 3;
        int indicatorFootCenterY = mWheelCenterY - mHalfItemHeight * 4 / 3;
