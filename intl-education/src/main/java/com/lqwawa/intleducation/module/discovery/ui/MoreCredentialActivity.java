...
public class MoreCredentialActivity extends MyBaseActivity implements View.OnClickListener{
    private static final String TAG = "MoreCredentialActivity";
    ...
    public static void start(Activity activity, String organId){
        activity.startActivity(new Intent(activity, MoreCredentialActivity.class)
                .putExtra("id", organId));
    }
    @Override
    ...
    private void initViews() {
        ...
        topBar.setTitle(getString(R.string.all_credential));
        topBar.setBack(true);
    ...
    private void initData() {
        organItemAdapter = new OrganItemAdapter(this, 3);
        pullToRefreshView.showRefresh();
        getData();
    }
