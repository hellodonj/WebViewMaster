...
public class MinorityLanguageHolder extends FrameLayout
    ...
    public MinorityLanguageHolder(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public MinorityLanguageHolder(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView(){
        final View view = mRootView = mLayoutInflater.inflate(R.layout.item_lq_minority_language_course_layout,this);
        // 标题文本
