 ...
 * **********************************
 */
public class EnglishCourseInternationalHolder extends FrameLayout
    ...
    private ImageView mCourse1,mCourse2,mCourse3,/*mCourse4,*/mCourse5,mCourse6;

    public EnglishCourseInternationalHolder(Context context) {
        this(context,null);
    }

    public EnglishCourseInternationalHolder(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public EnglishCourseInternationalHolder(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView(){
        final View view = mRootView = mLayoutInflater.inflate(R.layout.item_lq_english_international_course_layout,this);
        // 标题文本
        ...
        mCourse5 = (ImageView) view.findViewById(R.id.course5);
        mCourse6 = (ImageView) view.findViewById(R.id.course6);
        ...
        mCourse5.setOnClickListener(this);
        mCourse6.setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        }else if(viewId == R.id.course5){
            mNavigator.onClickClassify(entities.get(3));
        }else if(viewId == R.id.course6){
            mNavigator.onClickClassify(entities.get(4));
        }
    }
    ...
    public void updateView(@NonNull LQCourseConfigEntity entity){
        if(!EmptyUtil.isEmpty(entity)){
            ...
            try {
                ...
                // 获取到第一个显示数据
                LQCourseConfigEntity entity5 = childList.get(3);
                ImageUtil.fillDefaultView(mCourse5,entity5.getThumbnail());

                // 获取到第一个显示数据
                LQCourseConfigEntity entity6 = childList.get(4);
                ImageUtil.fillDefaultView(mCourse6,entity6.getThumbnail());
