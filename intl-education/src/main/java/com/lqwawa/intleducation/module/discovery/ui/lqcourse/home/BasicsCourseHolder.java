 ...
 * **********************************
 */
public class BasicsCourseHolder extends FrameLayout
    ...
    public BasicsCourseHolder(Context context) {
        this(context,null);
    }

    public BasicsCourseHolder(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public BasicsCourseHolder(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView(){
        final View view = mRootView = mLayoutInflater.inflate(R.layout.item_lq_basics_course_layout,this);
        // 标题文本
