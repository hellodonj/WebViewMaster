 ...
 * @function V5.1.0小语种课程
 * @date 2018/05/02 10:15
 * @history v1.0
 * **********************************
 */
public class NewMinorityLanguageHolder extends FrameLayout
    ...
    private ImageView mCourse1,mCourse2,mCourse3,mCourse4,mCourse5;

    public NewMinorityLanguageHolder(Context context) {
        this(context,null);
    }

    public NewMinorityLanguageHolder(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public NewMinorityLanguageHolder(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView(){
        final View view = mRootView = mLayoutInflater.inflate(R.layout.item_lq_new_minority_language_course_layout,this);
        // 标题文本
    ...
    public void updateView(@NonNull LQCourseConfigEntity entity){
        if(!EmptyUtil.isEmpty(entity)){
            ...
            try {
                ...
                // 获取到第四个显示数据
                LQCourseConfigEntity entity4 = childList.get(4);
