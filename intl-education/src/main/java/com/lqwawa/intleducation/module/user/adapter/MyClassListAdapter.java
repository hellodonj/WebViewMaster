...
public class MyClassListAdapter extends MyBaseAdapter {
    private Activity activity;
    private List<MyClassVo> list;
    private LayoutInflater inflater;
    private ImageOptions imageOptions;

    public MyClassListAdapter(Activity activity) {
        this.activity = activity;
        this.inflater = LayoutInflater.from(activity);
        list = new ArrayList<MyClassVo>();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHolder holder;
        MyClassVo vo = list.get(position);
        if (convertView != null) {
        ...
        x.image().bind(holder.user_head_iv, ("" + vo.getGroupUuid()).trim(), imageOptions);
     ...
     * @param list
     */
    public void setData(List<MyClassVo> list) {
        if (list != null) {
            this.list = new ArrayList<MyClassVo>(list);
        } else {
            this.list.clear();
        }
    }
     ...
     * @param list
     */
    public void addData(List<MyClassVo> list) {
