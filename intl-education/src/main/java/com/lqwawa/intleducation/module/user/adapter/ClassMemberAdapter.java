...
public class ClassMemberAdapter extends MyBaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView != null) {
            ...
            convertView = inflater.inflate(R.layout.mod_user_class_member_grid_item, null);
    ...
    public void addData(ContactVo data){
        this.list.add(data);
    }
