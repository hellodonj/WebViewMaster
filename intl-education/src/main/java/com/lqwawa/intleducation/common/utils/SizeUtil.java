...
public final class SizeUtil {
    ...
    public static int dp2px(final float dpValue) {
        final float scale = UIUtil.getApp().getResources().getDisplayMetrics().density;
    ...
    public static int sp2px(final float spValue) {
        final float fontScale = UIUtil.getApp().getResources().getDisplayMetrics().scaledDensity;
