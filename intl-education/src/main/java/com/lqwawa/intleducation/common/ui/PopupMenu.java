...
public class PopupMenu extends PopupWindow {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (isChangeTextTitleAttr){
				...
				if (data.isOnlineSchool) {
					Drawable rightDrawable = mContext.getResources().getDrawable(R.drawable.ic_online_school_tag);
	...
	public static class PopupMenuData {
		// 保存二维码
		public static final int TYPE_SAVE_QRCODE = 1;
		// 推荐给好友
		public static final int TYPE_RECOMMEND_FRIEND = 2;
		// 成为机构老师
		public static final int TYPE_JOIN_SCHOOL_TEACHER = 3;
		// 关注
		public static final int TYPE_ATTENTION = 4;
		// 取消关注
		public static final int TYPE_CANCEL_ATTENTION = 5;
