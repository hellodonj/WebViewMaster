...
public final class ActivityUtil {
    ...
    public static boolean isActivityExists(@NonNull final String packageName,
        ...
        return !(UIUtil.getApp().getPackageManager().resolveActivity(intent, 0) == null ||
                intent.resolveActivity(UIUtil.getApp().getPackageManager()) == null ||
                UIUtil.getApp().getPackageManager().queryIntentActivities(intent, 0).size() == 0);
    }
    ...
    public static String getLauncherActivity() {
        return getLauncherActivity(UIUtil.getApp().getPackageName());
    }
    ...
    public static String getLauncherActivity(@NonNull final String packageName) {
        ...
        PackageManager pm = UIUtil.getApp().getPackageManager();
    ...
    public static Activity getTopActivity() {
        Activity activity = UIUtil.getTopActivity();
        if (activity != null) {
            return activity;
        }
        List<Activity> activities = UIUtil.getListActivity();
    ...
    public static void finishAllActivities(final boolean isLoadAnim) {
        List<Activity> activityList = UIUtil.getListActivity();
    ...
    private static Context getActivityOrApp() {
        ...
        return topActivity == null ? UIUtil.getApp() : topActivity;
    }
