...
public class CustomRaidoSelDialog extends Dialog {
    ...
    public CustomRaidoSelDialog(Context context, int theme) {
        super(context, theme);
    }
    ...
    public static class Builder {
        ...
        public CustomRaidoSelDialog create() {
            LayoutInflater inflater = (LayoutInflater) context
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            // instantiate the dialog with the custom Theme  
            final CustomRaidoSelDialog dialog = new CustomRaidoSelDialog(context, R.style.CustomDialog);
            View layout = inflater.inflate(R.layout.widgets_dialog_radio_sel_layout, null);
            dialog.addContentView(layout, new LayoutParams(
                    LayoutParams.FILL_PARENT, LayoutParams.WRAP_CONTENT));
            dialog.getWindow().setBackgroundDrawableResource(R.drawable.custom_dialog_bg);
            // set the dialog title  
            ((TextView) layout.findViewById(R.id.title)).setText(title);
            final RadioGroup radioGroupSel = (RadioGroup) layout.findViewById(R.id.sel_rg);
                            ...
                            .setOnClickListener(new View.OnClickListener() {
                                public void onClick(View v) {
                                    positiveButtonClickListener.onClick(dialog,
                                            radioGroupSel.getCheckedRadioButtonId()
                                                    == R.id.rb_current_class ? 0 : 1);
                                }
                            });
                }
            } else {
