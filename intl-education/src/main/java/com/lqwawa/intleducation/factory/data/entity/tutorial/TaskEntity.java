...
public class TaskEntity implements Serializable {
    ...
    public void setAssHeadPicUrl(String AssHeadPicUrl) {
        this.AssHeadPicUrl = AssHeadPicUrl;
    }
    ...
    public String getT_TaskTypeName() {
        return T_TaskTypeName;
    }

    public void setT_TaskTypeName(String T_TaskTypeName) {
        this.T_TaskTypeName = T_TaskTypeName;
    }
