...
public class VideoView extends SurfaceView implements IMediaController.MediaPlayerControl {
    ...
    private IMediaController.Proxy mMediaController;
    ...
    public void setVideoPath(String path, boolean isLooping) {
        setVideoURI(Uri.parse(path), isLooping);
    }
    ...
    public void setVideoURI(Uri uri, boolean isLooping) {
        setVideoURI(uri, null, isLooping);
    }
    ...
    public void setVideoURI(Uri uri, Map<String, String> headers) {
        setVideoURI(uri, headers, false);
    }

    public void setVideoURI(Uri uri, Map<String, String> headers, boolean isLooping) {
        mUri = uri;
        mHeaders = headers;
        mSeekWhenPrepared = 0;
...
//        mMediaController = controller;
        mMediaController = new IMediaController.Proxy(controller);
        attachMediaController();
    }
