...
package com.icedcap.dubbing.soundfile;
...
public class CheapWAV extends CheapSoundFile {
    ...
    public void ReadFile(File inputFile)
        ...
        while (mOffset + 8 <= mFileSize) {
            ...
            Log.e("ddd", "((0xff & chunkHeader[7]) << 24) = " + ((0xff & chunkHeader[7]) << 24));
            Log.e("ddd", "((0xff & chunkHeader[6]) << 16) = " + ((0xff & chunkHeader[6]) << 16));
            Log.e("ddd", "((0xff & chunkHeader[5]) << 8) = " + ((0xff & chunkHeader[5]) << 8));
            Log.e("ddd", "((0xff & chunkHeader[4])) = " + ((0xff & chunkHeader[4])));
            ...
            if (chunkHeader[0] == 'f' &&
                ...
                Log.e("ddd", "skip chunk len = " + chunkLen);
                try {
