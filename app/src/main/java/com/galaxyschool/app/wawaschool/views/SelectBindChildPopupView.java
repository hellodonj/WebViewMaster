...
public class SelectBindChildPopupView extends PopupWindow implements View.OnClickListener, View.OnTouchListener, WheelView.OnWheelChangedListener {

    public interface OnRelationChangeListener {
        void onRelationChange(int index, String relationType);
    }
    ...
    public SelectBindChildPopupView(Activity context, int index, OnRelationChangeListener listener,String[] dataArray) {
        super(context);
        mContext = context;
        relationIndex = index;
...
//        mRelationTypes = mContext.getResources().getStringArray(R.array.relation_types);
        mRelationTypes=dataArray;
        initViews();
    }
    ...
    private void initViews() {
        ...
        mCancelBtn.setTextColor(mContext.getResources().getColor(R.color.text_green));

        mConfirmBtn = (TextView) mRootView.findViewById(R.id.relation_confirm_btn);
        mConfirmBtn.setTextColor(mContext.getResources().getColor(R.color.text_green));
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.relation_confirm_btn:
                if(listener != null) {
                    listener.onRelationChange(curIndex, mRelationTypes[curIndex]);
                }
                dismiss();
                break;
...
//                    }
                    listener.onRelationChange(relationIndex, null);
                }
                dismiss();
                break;
        }
