...
public class ArcProgressbar extends ProgressBar{
    ...
    private final int DEFAULT_mRadius = dp2px(100);
    private final int DEFAULT_mUnmProgressColor = 0xffeaeaea;
    private final int DEFAULT_mProgressColor = Color.parseColor("#56b37b");
    ...
    public ArcProgressbar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mRadius = attributes.getDimensionPixelOffset(R.styleable.ArcProgress_radiuss,
                DEFAULT_mRadius);
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        mArcRectf = new RectF(mBoardWidth, mBoardWidth, mRadius * 2 - mBoardWidth, mRadius * 2 - mBoardWidth);
    }
