 ...
 */
package com.galaxyschool.app.wawaschool.chat.applib.controller;
...
//        }
    ...
    protected void initListener(){
        ...
        connectionListener = new EMConnectionListener() {
            ...
            public void onDisconnected(int error) {
            	...
            	}else if (error == EMError.USER_LOGIN_ANOTHER_DEVICE) {//账户在另外一台设备登录
    ...
    private String getAppName(int pID) {
        ...
        Log.e(TAG,"*************getRunningAppProcesses********");
