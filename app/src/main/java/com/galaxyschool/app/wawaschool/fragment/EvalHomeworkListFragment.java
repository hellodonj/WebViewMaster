...
public class EvalHomeworkListFragment extends ContactsListFragment {
    ...
    void initViews() {
        if (getArguments() != null) {
            ...
            userInfo = (UserInfo) getArguments().get(UserInfo.class.getSimpleName());
                            ...
                            public void onClick(View v) {
                                ...
                                if (Utils.isLQCourse(originType)) {
                                    ...
                                    CourseOpenUtils.openCourseDetailsDirectly(getActivity(), myTask,
                                            roleType, getMemeberId(), studentId, userInfo, true);
                                }
                                //更新数据
                    ...
                    public View getView(int position, View convertView, ViewGroup parent) {
                        ...
                        if (ivWarn != null){
                            if (roleType == RoleType.ROLE_TYPE_TEACHER || roleType == RoleType.ROLE_TYPE_PARENT) {
                                if (data.isHasCommitTaskReview() && !TextUtils.isEmpty(data.getTaskScore())) {
...
//                                        showDeletePopwindow(data,viewAnchor);
    ...
    public static void setHasContentChanged(boolean hasContentChanged) {
        EvalHomeworkListFragment.hasContentChanged = hasContentChanged;
    }
