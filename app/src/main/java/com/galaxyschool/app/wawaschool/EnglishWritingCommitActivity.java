 ...
 */
public class EnglishWritingCommitActivity extends BaseFragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragment = new EnglishWritingCommitFragment();
        fragment.setArguments(args);
        FragmentTransaction ft = getSupportFragmentManager().beginTransaction();
        ft.replace(R.id.activity_body, fragment, EnglishWritingCommitFragment.TAG);
        ft.commit();
    }
