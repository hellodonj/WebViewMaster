...
public class LetvVodHelperNew {
    ...
    public static class VodVideoBuilder{
        ...
        public VodVideoBuilder setIsPublicRes(boolean isPublicRes) {
            mLetvVodHelper.isPublicRes = isPublicRes;
            return this;
        }

        public VodVideoBuilder setIsFromChoiceLib(boolean isFromChoiceLib) {
            mLetvVodHelper.isFromChoiceLib = isFromChoiceLib;
            return this;
        }

        public VodVideoBuilder setCollectionSchoolId(String mCollectionSchoolId) {
            mLetvVodHelper.mCollectionSchoolId = mCollectionSchoolId;
            return this;
        }
    ...
    private void build() {
        Intent intent = new Intent(activity, VodPlayActivity.class);
        ...
        mBundle.putBoolean(VodPlayActivity.KEY_ISPUBLICRES, isPublicRes);
        mBundle.putBoolean(VodPlayActivity.KEY_ISFROMCHOICELIB, isFromChoiceLib);
        mBundle.putString(VodPlayActivity.KEY_COLLECTIONSCHOOLID, mCollectionSchoolId);
        ...
        if (!TextUtils.isEmpty(vuid) && VodVideoSettingUtil.getInstance().getMediaType() == VodVideoSettingUtil.VIDEO_TYPE
            ...
            mBundle.putString(PlayerParams.KEY_PLAY_UUID, "b68e945493");
            ...
            activity.startActivity(new Intent(activity, MediaPlayerActivity.class).
                    putExtra(MediaPlayerActivity.DATA, mBundle));
            return;
        }
