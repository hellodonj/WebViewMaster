...
public class GroupDetailsActivity extends BaseActivity implements OnClickListener {
	...
	public void clearGroupHistory() {
		...
		EMConversation conversation = EMClient.getInstance().chatManager().getConversation(group
				.getGroupId(), EMConversation.EMConversationType.GroupChat,true);
...
//				button.setCompoundDrawables(null, avatar, null, null);
	...
	protected void updateGroup() {
		new Thread(new Runnable() {
			public void run() {
				try {
					final EMGroup returnGroup = EMClient.getInstance().groupManager().getGroupFromServer
							(groupId);
					// 更新本地数据
