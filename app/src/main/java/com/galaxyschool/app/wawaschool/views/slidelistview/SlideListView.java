...
public class SlideListView extends ListView {
	...
	private boolean mbShowFullHeight = true;
	...
	private void init(AttributeSet attrs) {
		if (attrs != null) {
			...
			mSlideLeftAction = SlideAction.mapIntToValue(
				styled.getInteger(R.styleable.SlideListView_slideLeftAction, 0));
			mSlideRightAction = SlideAction.mapIntToValue(
				styled.getInteger(R.styleable.SlideListView_slideRightAction, 0));
			mbShowFullHeight = styled.getBoolean(R.styleable.SlideListView_showFullHeight, true);
			styled.recycle();
		}
