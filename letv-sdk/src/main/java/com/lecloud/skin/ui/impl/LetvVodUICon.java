...
//		UI 分层
        ...
        findViewById(R.id.iv_audio_bg).setVisibility(VodVideoSettingUtil.getInstance().getMediaType()
        == VodVideoSettingUtil.AUDIO_TYPE ? VISIBLE : GONE);
    ...
    public void showTopRightMoreButton( boolean isShow) {
        if (mV4TopTitleView!=null){
            mV4TopTitleView.showTopRightMoreButton(isShow);
        }
    }
    ...
    public void showFullBtn(boolean isShow) {
        ...
        if (isShow) {
            ...
            mBig.setVisibility(VISIBLE);
        } else {
            mSmall.setVisibility(INVISIBLE);
            mBig.setVisibility(INVISIBLE);
        }

    }

    public void setButtonMoreListener(V4TopTitleView.OnButtonMoreListener moreListener) {
        mV4TopTitleView.setButtonMoreListener(moreListener);
    }
}
