...
public class V4SmallLiveMediaControllerNew extends V4LargeLiveMediaControllerNew {
    ...
    protected void onInitView() {
        ...
        mEndonlineBtn= (TextView) findViewById(R.id.bottom_end_online);
        mEndonlineBtn.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                if (mLetvUIListener!=null){
                    mLetvUIListener.onEndOnline();
                }
            }
        });
        ...
        mBaseLiveSeekBar.setOnBackToLiveListener(new V4LivePageSeekBar.OnBackToLiveListener() {
            ...
            public void onPositionChanged(int leftMargin) {
                LayoutParams params = (LayoutParams) mBaseBackToLive.getLayoutParams();
