...
//    private boolean mFullscreenEnabled = false;
    ...
    private boolean isHideTitleLayout;
    ...
    private void initControllerView(View v) {
        ...
        mBtnMore = (ImageView) v.findViewById(R.id.iv_more);
    ...
    public void setBtnMoreVisible(boolean visible) {
        mBtnMore.setVisibility(visible ? VISIBLE : INVISIBLE);
        mBtnMore.setClickable(visible);
...
//    }
    ...
    public void hideTitleLayout(boolean hideTitleLayout){
        if (mTitleLayout != null){
            isHideTitleLayout = hideTitleLayout;
            mTitleLayout.setVisibility(hideTitleLayout ? View.GONE : View.VISIBLE);
        }
    }
