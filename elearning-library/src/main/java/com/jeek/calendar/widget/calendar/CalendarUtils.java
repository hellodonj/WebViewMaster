...
public class CalendarUtils {
    ...
    public List<Integer> setTaskHints(int year, int month, List<Integer> days) {
        String key = hashKey(year, month);
        List<Integer> hints = sUtils.sMonthTaskHint.get(key);
        if (hints == null) {
            hints = new ArrayList<>();
    ...
    public static int getMonthDistence(DateTime d1, DateTime d2){
        return (d1.getYear() - d2.getYear()) * 12
