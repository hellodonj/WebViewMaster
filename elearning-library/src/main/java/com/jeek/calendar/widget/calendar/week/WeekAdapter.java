...
public class WeekAdapter extends PagerAdapter {
    ...
    static {
        mWeekCount = CalendarUtils.getWeeksAgo(1901, 1, 1, 2099, 12, 31);
    }
    ...
    public WeekAdapter(Context context, TypedArray array, WeekCalendarView weekCalendarView) {
        ...
        initStartDate();
        //mWeekCount = array.getInteger(R.styleable.WeekCalendarView_week_count, 10428);
    }

    private void initStartDate() {
        mStartDate = MonthAdapter.baseDate;
